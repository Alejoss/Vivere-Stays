    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('competitor_average', models.FloatField(blank=True, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('user', models.ForeignKey(blank=True, help_text='User who created this dynamic increment', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='dynamic_increments_v2', to=settings.AUTH_USER_MODEL)),
            ],
            options={
