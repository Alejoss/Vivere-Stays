    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['email', 'created_at'], name='webapp_back_email_34ed11_idx'), models.Index(fields=['user', 'created_at'], name='webapp_back_user_id_f35e8b_idx'), models.Index(fields=['expires_at'], name='webapp_back_expires_e37c81_idx')],
            },
        ),
        migrations.CreateModel(
            name='Notification',
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['user', 'is_read', 'created_at'], name='webapp_back_user_id_1661a0_idx'), models.Index(fields=['user', 'is_new'], name='webapp_back_user_id_eb48f7_idx'), models.Index(fields=['user', 'category'], name='webapp_back_user_id_a553dc_idx'), models.Index(fields=['created_at'], name='webapp_back_created_6582fb_idx')],
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['user', 'status'], name='webapp_back_user_id_e66706_idx'), models.Index(fields=['created_at'], name='webapp_back_created_daefe1_idx')],
            },
        ),
    ]
