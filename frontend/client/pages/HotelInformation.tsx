...
export default function HotelInformation() {
  ...
  const handleContinue = async () => {
    ...
    if (validateForm()) {
      ...
      // Save hotel data to localStorage for PMS Integration step
      const hotelData = {
        ...
        number_of_rooms: formData.numberOfRooms ? parseInt(formData.numberOfRooms) : undefined,
        property_type: formData.propertyType,
        is_onboarding: true, // Mark this as part of the onboarding process
      };

      // Save to localStorage for PMS Integration step
      localStorage.setItem('hotelDataForPMS', JSON.stringify(hotelData));
      
      console.log("Hotel data saved to localStorage for PMS Integration");
          ...
          <div className="space-y-[14px]">
            ...
            {formData.bookingUrl.trim() ? (
              ...
              <div className="flex items-center gap-1">
                ...
                <span className="text-[12px] text-[#FF0404]">
                  You won't be able to see competitors automatically without your
                  Booking.com URL. You'll need to fill them in manually.
                </span>
              </div>
            )}
          </div>
            ...
            <div className="flex-1 space-y-2">
              ...
              <div className="space-y-1">
                <input
                  ...
                  placeholder="Spain"
                  className={`w-full h-[60px] px-4 py-[17px] border rounded-[8px] bg-white text-[16px] placeholder:text-[#9CAABD] focus:outline-none transition-colors ${getFieldBorderColor("country")} ${getFieldTextColor("country")}`}
                />
