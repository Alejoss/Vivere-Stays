...
export default function WelcomeComplete() {
  ...
  return (
    <div className="min-h-screen bg-[#F6F9FD] flex flex-col items-center px-4 py-8 w-full">
      ...
      {/* Main Content Card */}
      <div className="bg-white rounded-[20px] shadow-[0_0_30px_0_rgba(0,0,0,0.25)] w-full max-w-[832px] p-[65px] relative">
        {/* Success Icon */}
        ...
        <div className="bg-[#EEF9FF] border border-[#D8E9FE] rounded-[8px] p-8 mb-8 relative">
          {/* Robot Icon */}
          ...
          <div className="absolute right-8 top-6">
            <img
              src="https://api.builder.io/api/v1/image/assets/TEMP/e9e4c234a69a5388da6ea4232bd7347ac595f9e5?width=156"
              alt="Searching"
          ...
          <div className="absolute right-8 top-[115px]">
            {!isCompleted ? (
              <img
                src="https://api.builder.io/api/v1/image/assets/TEMP/5673195f9fc1e7e324bd19d54ee43e8246c7f8e5?width=90"
                alt="1%"
                className="w-[45px] h-[29px]"
              />
            ) : (
              <img
                src="https://api.builder.io/api/v1/image/assets/TEMP/7e29c280ba7063939f5973ed7c2d187b70a73bcb?width=90"
                alt="100%"
                className="w-[45px] h-[29px]"
              />
            )}
